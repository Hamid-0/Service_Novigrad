...
/* Admin adds the service "Health Card", once added, the admin will click on the "Edit" button
...
public class HealthCardFormSelectionTest {
    ...
    public void serviceFormSelectionTest() {
        ...
        ViewInteraction appCompatCheckBox = onView(
                allOf(withId(R.id.cbFirstName), withText("First Name"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatCheckBox2 = onView(
                allOf(withId(R.id.cbLastName), withText("Last Name"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tvFinalResult), withText("First Name\nLast Name\nAddress\n"),
