...
public class SearchAdapterClass extends RecyclerView.Adapter<SearchAdapterClass.ViewHolder> {
    ...
    public SearchAdapterClass(List<ServiceModelClass> service, Context context) {
    ...
    @NonNull
    @Override
    public com.example.service_novigrad.SearchAdapterClass.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.service_item_list,parent,false);
        com.example.service_novigrad.SearchAdapterClass.ViewHolder viewHolder = new com.example.service_novigrad.SearchAdapterClass.ViewHolder(view);
        return viewHolder;
    }


    @Override
        public void onBindViewHolder(@NonNull final com.example.service_novigrad.SearchAdapterClass.ViewHolder holder, final int position) {
